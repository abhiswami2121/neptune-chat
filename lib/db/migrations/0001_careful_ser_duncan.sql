...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "SandboxRun" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"sandboxId" text NOT NULL,
	"userId" uuid NOT NULL,
	"toolName" text NOT NULL,
	"runtime" text DEFAULT 'node24' NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "SandboxRun" ADD CONSTRAINT "SandboxRun_userId_User_id_fk" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
