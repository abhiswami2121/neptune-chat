...
const hyperswitchManifest: ConnectorManifest = {
  ...
  capabilities: [
    { id: "createPaymentLink", label: "Create Payment Link", description: "Generate a branded payment link for a customer", icon: "Link" },
    { id: "listPayments", label: "List Payments", description: "List recent payments with status and connector info", icon: "List" },
    { id: "refundPayment", label: "Refund Payment", description: "Refund a Hyperswitch payment by payment_id", icon: "Undo" },
  ],
